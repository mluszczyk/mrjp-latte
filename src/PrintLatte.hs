...
instance Print (TopDef a) where
  prt i e = case e of
    FnDef _ type_ cident args block -> prPrec i 0 (concatD [prt 0 type_, prt 0 cident, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 block])
  prtList _ [x] = concatD [prt 0 x]
  prtList _ (x:xs) = concatD [prt 0 x, prt 0 xs]
instance Print (Arg a) where
  prt i e = case e of
    Arg _ type_ cident -> prPrec i 0 (concatD [prt 0 type_, prt 0 cident])
  prtList _ [] = concatD []
  prtList _ [x] = concatD [prt 0 x]
...
instance Print (Stmt a) where
  prt i e = case e of
    ...
    ForEach _ type_ cident expr stmt -> prPrec i 0 (concatD [doc (showString "for"), doc (showString "("), prt 0 type_, prt 0 cident, doc (showString ":"), prt 0 expr, doc (showString ")"), prt 0 stmt])
    SExp _ expr -> prPrec i 0 (concatD [prt 0 expr, doc (showString ";")])
  prtList _ [] = concatD []
  prtList _ (x:xs) = concatD [prt 0 x, prt 0 xs]
instance Print (Item a) where
  prt i e = case e of
    NoInit _ cident -> prPrec i 0 (concatD [prt 0 cident])
...
instance Print (Expr a) where
  prt i e = case e of
    ...
    EAt _ cident exprs -> prPrec i 6 (concatD [prt 0 cident, doc (showString "["), prt 0 exprs, doc (showString "]")])
